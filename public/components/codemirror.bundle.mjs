  ...
  static resolve(base2, compartments, oldState) {
    ...
    if (oldState) {
      ...
      for (let id2 in address) {
        let cur2 = address[id2], prev = oldState.config.address[id2];
        if (prev != null && (cur2 & 1) == 0 && canReuse(+id2, 0))
...
var EditorState = class {
  constructor(config2, doc2, selection, values, tr = null) {
    this.config = config2;
    this.doc = doc2;
    this.selection = selection;
    this.values = values;
...
export {
  codemirror6_default as default
};
